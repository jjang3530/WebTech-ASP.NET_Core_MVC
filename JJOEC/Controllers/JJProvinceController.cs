...
{
    public class JJProvinceController : Controller
    {
        private readonly OECContext _context;

        public JJProvinceController(OECContext context)
        {
            _context = context;
        }
        ...
        // GET: JJProvince/Create
        public IActionResult Create()
        {
            ViewData["CountryCode"] = new SelectList(_context.Country, "CountryCode", "CountryCode");
            ViewData["CountryName"] = new SelectList(_context.Country.OrderBy(a=>a.Name), "Name", "Name");
            return View();
        }

        // POST: JJProvince/Create
